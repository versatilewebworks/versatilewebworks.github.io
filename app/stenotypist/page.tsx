        ...
        <div className="grid gap-6 lg:grid-cols-[1.2fr_1fr]">
          ...
          <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-soft">
            <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
              ...
              <span className="rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-emerald-700">Realtime</span>
            </div>
            ...
            <label className="grid gap-2 text-sm font-medium text-slate-700">
              ...
              />
              <p className="text-xs text-slate-500">Paste is disabled here to keep the challenge authentic.</p>
            </label>
